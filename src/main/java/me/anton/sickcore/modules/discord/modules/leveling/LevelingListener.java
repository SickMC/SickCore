        ...
        for (DiscordLevel value : DiscordLevel.values()) {
            if (oldPoint == value.getEnd() && oldPoint + 1 == value.getNext().getStart()){
                if (value.getNext().getReward().expire() == -1){
                    event.getMessage().replyEmbeds(value.getNext().getReward() != null ? new EmbedBuilder(event.getMember()).setTitle("Level Up").mention(event.getMember()).setContent(event.getMember().getAsMention() + "\nYou gained a level up from **" + value.getName() + "** to **" + value.getNext().getName() + "**!"
                            + "\nYour reward is a " + value.getNext().getReward().getName() + ":\n >>> **" + value.getNext().getReward().getType() + ": " + value.getNext().getReward().getValue() + "** (permanent)").build() : new EmbedBuilder(event.getMember()).setTitle("Level Up").mention(event.getMember()).setContent(event.getMember().getAsMention() + "\nYou gained a level up from **" + value.getName() + "** to **" + value.getNext().getName() + "**!").build()).queue();
                }else if (value.getNext().getReward().expire() == 0){
                    event.getMessage().replyEmbeds(value.getNext().getReward() != null ? new EmbedBuilder(event.getMember()).setTitle("Level Up").mention(event.getMember()).setContent(event.getMember().getAsMention() + "\nYou gained a level up from **" + value.getName() + "** to **" + value.getNext().getName() + "**!"
                            + "\nYour reward is a " + value.getNext().getReward().getName() + ":\n >>> **" + value.getNext().getReward().getType() + ": " + value.getNext().getReward().getValue() + "**").build() : new EmbedBuilder(event.getMember()).setTitle("Level Up").mention(event.getMember()).setContent(event.getMember().getAsMention() + "\nYou gained a level up from **" + value.getName() + "** to **" + value.getNext().getName() + "**!").build()).queue();
                }else {
                    event.getMessage().replyEmbeds(value.getNext().getReward() != null ? new EmbedBuilder(event.getMember()).setTitle("Level Up").mention(event.getMember()).setContent(event.getMember().getAsMention() + "\nYou gained a level up from **" + value.getName() + "** to **" + value.getNext().getName() + "**!"
                            + "\nYour reward is a " + value.getNext().getReward().getName() + ":\n >>> **" + value.getNext().getReward().getType() + ": " + value.getNext().getReward().getValue() + "** (" + value.getNext().getReward().expire() + " days)").build() : new EmbedBuilder(event.getMember()).setTitle("Level Up").mention(event.getMember()).setContent(event.getMember().getAsMention() + "\nYou gained a level up from **" + value.getName() + "** to **" + value.getNext().getName() + "**!").build()).queue();
                }
            }
        }
    }
