...
public class PlayerInteractAtEntityEventHandler extends BukkitEventProvider<PlayerInteractAtEntityEvent> {
    ...
    public void handleEvent(PlayerInteractAtEntityEvent event) {
        ...
        provider.iterator(run -> run.onPlayerInteractAtEntity(event, bukkitPlayer));
    }
}
