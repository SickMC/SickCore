...
public class UnVanishCommand extends BaseCommand {
    ...
    public void onVanish(CommandSender sender){
        ...
        if (!VanishListInventory.vanishlist.contains(player.getPlayer())){player.getPlayer().sendMessage((String) player.api().languageObject("§4You are already unvanished!","Du bist bereits sichtbar!"));return;}
