...
public enum MonopolyStreet {
    ...
    GEFAENGNIS(Material.IRON_BARS, "Gefängnis"),
    SEESTRASSE(Material.PINK_CONCRETE, "Seestraße"),
    ELEKTRIZITAETSWERK(Material.GLOWSTONE_DUST, "Elektrizitätswerk"),
    ...
    AB_INS_GEFAENGNIS(Material.END_PORTAL_FRAME, "Ab ins Gefängnis"),
