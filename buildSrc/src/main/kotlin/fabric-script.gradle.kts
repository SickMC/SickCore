...
dependencies {
    ...
    include("org.mongodb:bson:${BuildConstants.kmongoVersion}")
    include("org.mongodb:bson-record-codec:${BuildConstants.kmongoVersion}")
    include("org.mongodb:mongodb-driver-core:${BuildConstants.kmongoVersion}")
    include("org.mongodb:mongodb-driver-reactivestreams:${BuildConstants.kmongoVersion}")
